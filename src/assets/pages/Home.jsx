...
function Home() {
  ...
  const [activeImage, setActiveImage] = useState(
    'https://images.unsplash.com/photo-1613743983303-b3e89f8a2b80?q=80&w=1024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  );
  ...
  const storyImages = {
    cauliflower:
      'https://images.unsplash.com/photo-1613743983303-b3e89f8a2b80?q=80&w=1024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    grape:
      'https://changyuan-fresh.github.io/FirstProject/assets/grape1-7a8c01cc.png',
    farmTotable:
      'https://images.unsplash.com/photo-1567513068697-fca8c2af4528?q=80&w=1024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    clam: 'https://images.unsplash.com/photo-1590794057118-99a053c5c3e1?q=80&w=1024&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  };
      ...
      <main>
        ...
        <section className="mt-6 position-relative">
          <div className="allProduct-banner-mx">
            ...
            <div className="position-absolute banner-text translate-middle d-lg-block d-flex flex-column align-items-stretch ">
              ...
              >
                <div className="dropdown position-absolute top-50 start-0 translate-middle-y z-2">
                  <button
                    className="btn btn-white btn-sm fw-semibold fs-lg-6 fs-7 border-end border-1 rounded-0 text-nowrap ms-1"
                    type="button"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    全部商品{' '}
                    <span className="material-symbols-outlined text-primary align-bottom">
                      keyboard_arrow_down
                    </span>
                  </button>
                ...
                >
                  <span className="search-btn material-symbols-outlined text-primary fs-2 position-absolute top-50 translate-middle-y  pe-4">
                    search
                  </span>
                </button>
              </form>
            ...
            <img
              src="images/Illustration/Top-Curve.png"
              alt=""
              className="d-block position-absolute bottom-0 start-0 allProduct-banner-mask"
            />
          </div>
        </section>
        {/* <!--3個理由--> */}
        <section className="reason ">
          <div className="container d-flex flex-column align-items-center py-lg-11 py-6">
            ...
            <div className="row row-cols-lg-3 row-cols-1 d-flex flex-lg-row flex-column align-items-center justify-content-ceter gy-6 ">
              <div className="col">
                <div
                  className="card bg-transparent border-0 d-flex flex-column align-items-center justify-content-ceter"
                  data-aos="fade-up"
                >
                  <picture>
                    <source
                      media="(min-width: 992px)"
                      srcSet="images/Illustration/Farmer-sm.png"
                    />
                    <img src="images/Illustration/Farmer.png" alt="#" />
                  </picture>
                  <div className="reason-card-body d-flex flex-column align-items-center ">
                    <h5 className="reason-card-title fs-lg-4 bg-accent text-white px-lg-6 px-8 py-lg-3 py-2 rounded-4 mb-3">
                      支持在地小農
                    </h5>
                    <p className="card-text fs-lg-5 fs-7 px-4 py-lg-6 py-3 bg-white rounded-3">
                      由彰化農民親手栽種，並確保每一份產品收益，妥當回饋農民，促進當地市場。
                    </p>
                  </div>
                </div>
              </div>
              <div className="col">
                ...
                >
                  <picture>
                    <source
                      media="(min-width: 992px)"
                      srcSet="images/Illustration/ITruck-sm.png"
                    />
                    <img src="images/Illustration/ITruck.png" alt="#" />
                  </picture>
                  <div className="reason-card-body d-flex flex-column align-items-center">
                    <h5 className="card-title fs-lg-4 bg-accent text-white px-lg-6 px-8 py-lg-3 py-2 rounded-4 mb-3">
                      產地新鮮直送
                    </h5>
                    <p className="reason-card-text fs-lg-5 fs-7 px-4 py-lg-6 py-3 bg-white rounded-3">
                      從田間到餐桌，確保產地直送，每一次配送都力求保存最新鮮的自然風味。
                    </p>
                  </div>
                </div>
              </div>
              <div className="col">
                ...
                >
                  <picture>
                    <source
                      media="(min-width: 992px)"
                      srcSet="images/Illustration/Earth-sm.png"
                    />
                  ...
                  <div className="reason-card-body d-flex flex-column align-items-center">
                    ...
                    <p className="reason-card-text fs-lg-5 fs-7 px-4 py-lg-6 py-3 bg-white rounded-3">
                      由專家嚴格控款，農作與畜產的用藥及碳排放，確保對環境以及您的健康無害。
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section>
          <div className="container py-lg-9 py-6">
            {/* 分類Nav */}
            <ul
              className="nav nav-tabs product-nav-tabs px-auto"
              id="MyProductTab"
              role="tablist"
            >
              <Swiper
                ...
                >
                  {filteredProducts.length > 0 ? (
                    filteredProducts.map(product => (
                      <SwiperSlide
                        key={product.id}
                        className="swiper-slide card border-0 home-products-card"
                      >
                        <div>
                          <Link
                          ...
                          >
                            <img
                              ...
                              alt={product.name}
                              className="rounded-4 product-index-img"
                            />
                          </Link>
                        </div>
                        <div className="card-body px-0">
                          ...
                          <div className="card-text d-flex">
                            <p className="text-accent fw-bold me-2">
                              NT${product.price}
                            </p>
        ...
        <section>
          <div className="container pt-lg-11 pt-6 pb-lg-8 pb-3 d-flex justify-content-lg-between justify-content-center">
            <div className="d-lg-flex d-none">
              <img
                src="images/Illustration/Pumpkin.png"
                alt="Pumpkin"
                className="me-8 d-xl-block d-none"
              />
              <img
                src="images/Illustration/persimmon.png"
                alt="persimmon"
                className="me-8"
              />
        ...
        <section className="bg-secondary story-bg">
          <div className="container py-lg-11 py-8 ">
            <div className="d-lg-flex justify-content-lg-between align-items-center">
              ...
              <div
                className="nav story-nav flex-column nav-pills "
                id="v-pills-tab"
                role="tablist"
                ...
                {stories.map(story => {
                  return (
                    <Link to={`/stories/${story.id}`} key={story.id}>
                      ...
                      >
                        {story.title}
                        <span className="material-symbols-outlined story-icon">
                          chevron_right
                        </span>
                      </button>
                    </Link>
          ...
          <div className="bg-white position-relative py-lg-7 py-3">
            <picture>
              <source
                media="(min-width: 992px)"
                srcSet="images/deco/Arrow-Curve.png"
              />
              <img
                src="images/deco/Arrow-Curve-sm.png"
                alt="Arrow-Curve"
        ...
        <section className="">
          <div className="container pt-8 d-lg-block d-flex flex-column-reverse">
            <div className="row row-cols-lg-3 row-cols-1 position-relative ">
              <div className="col px-0">
                <div className="card border-0" data-aos="fade-right">
                  <div className="card-body">
                    <h4 className="card-title fs-lg-1 text-accent text-lg-start text-center">
                      01
                    </h4>
                    <div className="d-flex flex-column align-items-center">
                      <picture>
                        <source
                          media="(min-width: 992px)"
                          srcSet="images/Illustration/Tree.png"
                        />
                        <img
                          src="images/Illustration/Tree-sm.png"
                          alt="Tree"
                    ...
                    <p className="fs-lg-2 fs-md-3 fs-5 text-primary text-center mt-lg-3 mt-1">
                      產地
                    </p>
                  </div>
                </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex flex-column align-items-center">
                      <picture>
                        <source
                          media="(min-width: 992px)"
                          srcSet="images/Illustration/Delivery.png"
                        />
                        <img
                          src="images/Illustration/Delivery-sm.png"
                          alt="Delivery"
                          className="promotion-img"
                        />
                      </picture>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex flex-column align-items-center">
                      <picture>
                        <source
                          media="(min-width: 992px)"
                          srcSet="images/Illustration/Eating.png"
                        />
                        <img
                          src="images/Illustration/Eating-sm.png"
                          alt="Eating"
                          className="promotion-img"
                        />
                      </picture>
              ...
              <div>
                <img
                  src="images/deco/Arrow-1.png"
                  alt="Arrow-1"
                  className="d-lg-block d-none promotion-arrow1"
                />
                <img
                  src="images/deco/Arrow-2.png"
                  alt="Arrow-2"
                  className="d-lg-block d-none promotion-arrow2"
                />
              </div>
            </div>
            <div className="d-flex flex-column align-items-center pt-lg-8 pt-0">
              <h1 className="d-lg-block d-none mb-6">
                產地到餐桌，全館滿千免運!
              </h1>
              <h4 className="d-lg-none text-center mb-6">
                產地到餐桌 <br></br> 全館滿千免運
              </h4>
              <Link to="/products">
                <button className="btn btn-primary promotion-btn border-0 fw-bold fs-lg-4 fs-5 text-white">
                  立即購買
                </button>
              </Link>
              <Lottie
                className="lottie-hand"
            ...
            <div className="row row-cols-lg-4 row-cols-md-2 row-cols-1 gy-4">
              <div className="col">
                <div className="card rounded-4 border-0 d-md-block d-flex flex-row h-100">
                  ...
                  <div className="card-body">
                    <h6 className="card-title fs-lg-5 fw-bold text-md-center text-start">
                      田園西餐廳
                    </h6>
                    <p className="card-text text-gray text-start">
                      本餐廳近日在「第十八屆國際美食國際美食大獎」中，榮獲「最佳新興餐廳」。
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col">
                <div className="card rounded-4 border-0 d-md-block d-flex flex-row h-100">
                  ...
                  <div className="card-body">
                    <h6 className="card-title fs-lg-5 fw-bold text-md-center text-nowrap text-start">
                      彰水路第一家滷肉飯
                    </h6>
                    <p className="card-text text-gray text-start">
                      本店榮獲 Google 評比「台灣小吃店家」網路聲量第二名！
                    </p>
                  </div>
                </div>
              </div>
