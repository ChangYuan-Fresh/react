                ...
                <section>
                    <div className="container py-lg-9 py-6">
                        ...
                        <ul className="nav nav-tabs product-nav-tabs px-auto" id="MyProductTab" role="tablist">
                            <div className="swiper MyProduct-nav-product-swiper px-6">
                        ...
                        <div className="tab-content" id="MyProductTabContent">
                            ...
                            <div className="tab-pane fade show active" id="hot-product" role="tabpanel" aria-labelledby="hot-product-tab">
                                {/* <!--熱門商品swiper--> */}
                                <div className="MyProduct-product-card-wrap swiper MyProduct-product-swiper py-8 position-relative ">
                                    <div className="swiper-wrapper">
                                        <a href="product-VegNFruit-orange.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type1.png" alt="type1" className="rounded-4 product-index-img" />
                                            </div>
                                        ...
                                        <a href="product-Dairy-milk.html" className="swiper-slide card border-0 swiper-slide-active  ">
                                            <div className="">
                                                <img src="/assets/images/type22.png" alt="type2" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    芬園鄉濃純牛奶-200ml
                                        ...
                                        <a href="product-Aquatic-clam.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type3.png" alt="type3" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    鹿港鎮鮮活文蛤-600g
                                        ...
                                        <a href="product-VegNFruit-pea.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type42.png" alt="type4" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    福興鄉翠綠豌豆-1000g
                                        ...
                                        <a href="product-Aquatic-giantGrouper.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                            ...
                            <div className="tab-pane fade " id="veggieNfruit" role="tabpanel" aria-labelledby="veggieNfruit-tab">
                                ...
                                <div className="MyProduct-product-card-wrap swiper MyProduct-product-swiper py-8 position-relative ">
                                    <div className="swiper-wrapper">
                                        <a href="product-VegNFruit-cauliflower.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="../assets/images/Cauliflower HQ (7).png" alt="cauliflower" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    埔鹽鄉白花椰菜
                                        ...
                                        <a href="product-VegNFruit-grapefruit.html" className="swiper-slide card border-0 swiper-slide-active  ">
                                            <div className="">
                                                <img src="../assets/images/Grapefruit by Engin Akyurt 1.png" alt="grapefruit" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    芬園鄉葡萄柚
                                        ...
                                        <a href="product-VegNFruit-orange.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="../assets/images/type1.png" alt="orange" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    埔鹽鄉多汁茂谷柑
                                        ...
                                        <a href="product-VegNFruit-pea.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type42.png" alt="pea" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    福興鄉翠綠豌豆
                                        ...
                                        <a href="product-VegNFruit-persimmon.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="../assets/images/Persimmon by Any Lane 1.png" alt="persimmon" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    埔心鄉甜柿
                            ...
                            <div className="tab-pane fade " id="meats" role="tabpanel" aria-labelledby="meats-tab">
                                ...
                                <div className="MyProduct-product-card-wrap swiper MyProduct-product-swiper py-8 position-relative ">
                                    <div className="swiper-wrapper">
                                        <a href="product-Meat-chickenLegs.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Meat-chickenWing.html" className="swiper-slide card border-0 swiper-slide-active  ">
                                            <div className="">
                                        ...
                                        <a href="product-Meat-pork.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Meat-porkRibs.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Meat-silkyChicken.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                            ...
                            <div className="tab-pane fade " id="seafood" role="tabpanel" aria-labelledby="seafood-tab">
                                ...
                                <div className="MyProduct-product-card-wrap swiper MyProduct-product-swiper py-8 position-relative ">
                                    <div className="swiper-wrapper">
                                        <a href="product-Aquatic-clam.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type3.png" alt="clam" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    鹿港鎮鮮活文蛤
                                        ...
                                        <a href="product-Aquatic-giantGrouper.html" className="swiper-slide card border-0 swiper-slide-active  ">
                                            <div className="">
                                                <img src="../assets/images/Mali Fish 1.png" alt="giantGrouper" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    大城鄉龍膽石斑魚
                                        ...
                                        <a href="product-Aquatic-milkFish.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Aquatic-oyster.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="../assets/images/Oyster HD Image (1) 1.png" alt="oyster" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    伸港鄉生猛鮮蚵
                                        ...
                                        <a href="product-Aquatic-whiteShrimp.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="../assets/images/Seafood from Pexels 1.png" alt="whiteShrimp" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    線西鄉白蝦
                            ...
                            <div className="tab-pane fade " id="eggNmilk" role="tabpanel" aria-labelledby="eggNmilk-tab">
                                ...
                                <div className="MyProduct-product-card-wrap swiper MyProduct-product-swiper py-8 position-relative ">
                                    <div className="swiper-wrapper">
                                        <a href="product-Dairy-duckEggs.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Dairy-eggs.html" className="swiper-slide card border-0 swiper-slide-active  ">
                                            <div className="">
                                        ...
                                        <a href="product-Dairy-milk.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                                <img src="/assets/images/type22.png" alt="milk" className="rounded-4 product-index-img" />
                                            </div>
                                            <div className="card-body px-0">
                                                <h6 className="card-title  product-card-title fs-lg-5 text-nowrap fw-bold">
                                                    芬園鄉濃純牛奶
                                        ...
                                        <a href="product-Dairy-milk2.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
                                        ...
                                        <a href="product-Dairy-redEggs.html" className="swiper-slide card border-0 swiper-slide-active ">
                                            <div className="">
