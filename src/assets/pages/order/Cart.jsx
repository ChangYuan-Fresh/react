          ...
          <div className="row">
            <div className="col-lg-9">
              ...
              <div>
                <div className="text-end py-3 col-12">
                  <button
                    className="btn btn-outline-accent px-5"
                    type="button"
                ...
                <div className="card mb-3" style={{ borderRadius: '16px' }}>
                  {cartList.carts?.map(item => {
                    return (
                      <div className="row g-0 border-bottom" key={item.id}>
                        <div className="col-lg-3 p-lg-5 p-0">
                          <img
                            src={item.product.imageUrl}
                            className="object-fit-cover rounded mb-4 mb-lg-0"
                          ...
                          <ul className="list-unstyled d-lg-flex justify-content-between mb-0 h-100">
                            <li className="d-lg-flex row w-100 px-0 g-0">
                              <div className="col-lg-4 card-body d-flex flex-column justify-content-between mb-0">
                                <div className="d-flex justify-content-between">
                                  <h4 className="card-title text-primary fs-6 fs-lg-4 mb-1 mb-lg-2">
                                    {item.product.title}
                                  </h4>
                                  <button
                              ...
                              <div className="col-lg-5 card-body d-flex py-0">
                                ...
                                <div className="card-body d-lg-none d-flex flex-column justify-content-end">
                                  <h2 className="text-accent fs-6 en-font text-end">
                                    NT${item.product.price}
                                  </h2>
                                  <p className="text-decoration-line-through text-gray fs-7 fw-normal en-font text-end">
                              ...
                              <div className="col-lg-3 d-lg-flex align-items-center d-none d-lg-block justify-content-between px-0">
                                <div>
                                  <h2 className="text-accent fs-5 fs-lg-4 en-font me-2">
                                    NT${item.product.price?.toLocaleString()}
                                  </h2>
                                  <p className="text-decoration-line-through text-gray fs-7 fs-lg-6 fw-normal en-font text-center">
                                    NT$
                                ...
                                <button className="btn px-1">
                                  <span
                                    className="material-symbols-outlined fs-lg-3 text-primary"
                                    onClick={() => removeCartItem(item.id)}
                                  >
                                    delete
                                  </span>
            ...
            <aside className="col-lg-3 d-none d-lg-block">
              <div className="z-0" style={{ position: 'sticky', top: '130px' }}>
                ...
                <div className="mt-6">
                  <Link
                    className={`btn btn-primary rounded rounded-3 w-100 text-white fs-5 fw-bold ${cartList.carts?.length < 1 ? 'disabled' : ''}`}
                    to="comfirmorder"
                  >
                    下一步
                  </Link>
            ...
            >
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <Link
                  className={`btn btn-primary rounded rounded-3 text-white fs-6 fw-bold py-3 px-5 ${cartList.carts?.length < 1 && 'disabled'}`}
                  to="comfirmorder"
                >
                  下一步
                </Link>
