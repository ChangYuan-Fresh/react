...
function ComfirmOrder() {
  ...
  useEffect(() => {
    if (paymentMethod !== 'creditCard') {
      ...
      register('cardnumber', {
        ...
        pattern: {
          value:
            /^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9]{2})[0-9]{12}|3[47][0-9]{13}|35[2-8][0-9]{12}|6(?:22[2-9]|4[0-9]{2}|[1-9]{2})[0-9]{12})$/,
          message: '格式不正確',
        },
      });
      register('expiryDate', {
  ...
  //是否為冷凍寄送
  const filterFrozen =
    cartList.carts?.filter(item => item.product?.is_frozen !== 0) || [];
  ...
  const totalAmount = Math.floor(
    (cartList.final_total ?? 0) + (shippingFee ?? 0)
  );
      ...
      <div className="container mb-lg-7 mb-0">
        <form className="row g-5" onSubmit={handleSubmit(onSubmit)}>
          <div className="col-lg-9">
            {/* 進度條 */}
            <div
              className="bg-secondary-200 row mb-5 mx-0"
              style={{ height: '92px', borderRadius: '16px' }}
            >
                ...
                <div className="m-0 m-lg-4 d-block ">
                  <div className="d-flex justify-content-between">
                    <div className="d-flex flex-column flex-lg-row align-items-center">
                      <button
                        type="button"
                        className="btn btn-sm btn-primary rounded-pill me-1 text-secondary"
                        style={{ width: '2rem', height: '2rem' }}
                      >
                        1
                      </button>
                      <p className="text-primary fs-lg-6 fs-7 text-nowrap">
                        購物車內容
                      </p>
                    </div>
                    <div
                    ...
                    <div className="d-flex flex-column flex-lg-row align-items-center">
                      <button
                        type="button"
                        className="btn btn-sm btn-secondary rounded-pill me-1 text-gray"
                        style={{ width: '2rem', height: '2rem' }}
                      >
                        3
                      </button>
                      <p className="text-gray fs-lg-6 fs-7 text-nowrap">
                        購物完成
                      </p>
                    </div>
                  </div>
            ...
            {/* 商品總覽 */}
            <div
              className="card bg-white mb-3 p-5 border-primary mb-5 d-none d-lg-block"
            ...
            >
              ...
              <div>
                <table className="table">
                  <thead>
                    <tr>
                      <th scope="col" className="text-muted fs-7" width="25%">
                        商品
                      </th>
                      <th
                        scope="col"
                        className="text-muted fs-7 text-center"
                        width="30%"
                      >
                        規格
                      </th>
            ...
            {/* 商品總覽mobile */}
            <div
              className="card d-lg-none border-primary mb-3"
              style={{ borderRadius: '16px' }}
            >
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray">
                          {item.product.description}x{item.qty}
                        </p>
                      </div>
            ...
            >
              ...
              <div>
                <div className="form-check">
                  ...
                  />
                  <label
                    className="form-check-label fs-lg-5 fs-6"
                    htmlFor="frozen"
                  >
                    冷凍宅配
            ...
            >
              ...
              <div className="my-0 my-lg-4">
                ...
                <div className="form-check mt-5">
                  ...
                  />
                  <label
                    className="form-check-label fs-lg-5 fs-6 en-font"
                    htmlFor="linePay"
                  >
                    <img
                      src="images/icon/linepay.png"
                      alt="applepay"
                      height="24px"
                      className="me-3"
                    />
            ...
            {/* 優惠卷 */}
            <div
              className="card bg-white mb-3 p-5 border-primary row g-0"
              style={{ borderRadius: '16px' }}
            >
              <div className="col-lg-6">
                ...
                <div className="input-group mb-3">
                  <input
                    type="text"
                    className="form-control px-lg-5 px-3"
                    onChange={getCouponCode}
                    placeholder="請輸入折扣碼"
                    value={couponCode}
                  />
                  <button
                    className="btn btn-primary text-white fs-lg-5 fs-6 px-lg-7 px-5"
                    type="button"
                    onClick={getDiscount}
                  >
                    確認
          ...
          <div className="col-lg-3 d-none d-lg-block">
            <div className="z-0" style={{ position: 'sticky', top: '130px' }}>
              ...
              <div className="mt-6">
                <Link
                  className="btn btn-primary rounded rounded-3 w-100 text-white fs-5 fw-bold"
                  to="/cart"
                >
                  上一步
                </Link>
                <button
                  type="submit"
                  className="btn btn-primary rounded rounded-3 w-100 text-white fs-5 fw-bold mt-3"
          ...
          {/* mobile */}
          <div
            className={`bg-secondary-200 p-3 d-lg-none fixed-bottom ${orderExtend && 'order-extend'}`}
          >
            {orderExtend && (
              <div>
            ...
            <div className="d-flex justify-content-between">
              <div>
                <div className="d-flex justify-content-between mb-1 align-items-center">
                  ...
                  <span
                    ...
                    onClick={handleOrderExtend}
                  >
                    {orderExtend ? 'keyboard_arrow_down' : 'keyboard_arrow_up'}
                  </span>
                </div>
                <div>
                  {filterFrozen.length > 0 || shippingType === 'frozen' ? (
                    cartList.total >= 1000 ? (
                      ...
                      <div className="bg-accent rounded rounded-3">
                        <div className="d-flex text-white align-items-center">
                          <span className="material-symbols-outlined me-1 fs-6  ms-1">
                            package_2
                          </span>
                          <p className="fs-7">
                            還差$ {1000 - cartList.total || 0}元免運
                          </p>
                        </div>
                      </div>
                    )
              ...
              <button
                type="submit"
                className="btn btn-primary rounded rounded-3 text-white fs-6 fw-bold py-3 px-4"
                disabled={cartList.length < 1}
              >
                確認付款
              </button>
