      ...
      <main>
        ...
        <section>
          <div className="container position-relative py-lg-11 py-4">
            <img
              src="images/Illustration/peace.png"
              alt="peace"
              className="story-deco1"
            />
            {/* <!--文章列表--> */}
                  ...
                  <div className="col" key={story.id}>
                    <div className="card story-card d-flex flex-lg-row flex-column border-0 rounded-4 bg-secondary-200 p-5 w-100">
                      ...
                      <div className="card-body d-flex flex-column justify-content-between px-lg-4 px-0 py-lg-0 pt-4 pb-0 w-50">
                        <div>
                          <div className="d-flex justify-content-between align-items-baseline ">
                            <h4 className="card-title fs-4 text-primary text-nowrap mb-2">
                              {story.title}
                            </h4>
                            <p className="card-text text-gray d-none d-lg-block">
                          ...
                          {story.description
                            ...
                            .map((line, idx) => (
                              <p
                                key={idx}
                                className="card-text fs-lg-6 fw-normal d-lg-block d-none"
                              >
                                {line.trim()}
                              </p>
                            ))}
                        ...
                        <div className="d-lg-flex justify-content-end d-none">
                          <Link
                            className="btn text-accent fw-bolder fs-3 d-flex align-items-center"
                            to={`/stories/${story.id}`}
                          >
                            看更多
                      ...
                      <Link to={`/stories/${story.id}`}>
                        <p className="card-text text-accent fw-bolder d-lg-none d-block ">
                          More
