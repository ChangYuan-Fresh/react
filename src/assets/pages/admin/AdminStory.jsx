...
function AdminStory() {
  ...
  const getArticleInfo = async id => {
    try {
      const res = await axios.get(
        `${baseUrl}/v2/api/${apiPath}/admin/article/${id}`
      );
              ...
              <table className="table d-none d-sm-table rounded-3">
                <thead>
                  <tr>
                    ...
                    <th
                      scope="col"
                      className="bg-secondary-200 text-gray fs-7 text-nowrap"
                    >
                      文章
                    </th>
                    <th
                  ...
                  {articles.map(article => {
                    return (
                      <tr key={article.id}>
                        ...
                        <td className="text-center text-gray fs-7 fw-normal">
                          ...
                          <div className="d-flex flex-column align-items-start">
                            <td className="d-flex">
                              ...
                              <p>
                                {!article.isPublic && (
                                  <span
                                    className="bg-secondary text-primary rounded-2 p-1 fw-normal"
                                    style={{ fontSize: '8px' }}
                                  >
                                    <small>未上架</small>
                                  </span>
