...
function DeleteCouponModal({ tempCoupon, getCouponList, delModelRef }) {
    ...
    return (
        <div className="modal fade" tabIndex="-1" ref={delCouponRef} id="delCouponModal" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-accent px-6 text-white" onClick={removeCoupon}>刪除</button>
                    </div>
                </div>
            </div>
        </div>
