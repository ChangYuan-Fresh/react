...
function CommentModal ({tempProduct,modelRef}){
    ...
    return (
    < div className="modal" tabIndex="-1" ref={orderlRef} style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
        <div className="modal-dialog modal-md">
            <div className="modal-content">
                ...
                <div className="modal-body px-5 mb-6">
                    <div className="d-flex p-4" style={{ backgroundColor: "rgba(250, 250, 250, 1)" }}>
                        <img src={tempProduct.product?.imageUrl} alt={tempProduct.id} className=" object-fit-cover rounded-1 me-5" style={{ width: "90px", height: "90px" }} />
                        <div className="my-auto">
                            <p className="fs-5 fw-bold">{tempProduct.product?.title}</p>
                            <p className="fs-7 text-muted">{tempProduct.product?.description}</p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div className="mb-5">
                        <label htmlFor="commentTitle" className="form-label">姓名</label>
                        <input type="text" className="form-control mb-3" id="commentTitle"
                    ...
                    <div className="mb-3">
                        <label htmlFor="commentContent" className="form-label">內文</label>
                        <textarea className="form-control" id="commentContent" rows="3"
                            placeholder="快來分享你的購物體驗！(最多 100 字)"></textarea>
                    </div>
                </div>
                <div className="modal-footer border-0 justify-content-center py-0 mb-5">
                    <button className="btn btn-primary fw-bold py-3 w-100 mb-3 text-white"
                        onClick={closeModal}>送出評價</button>
