...
function StoryModal({
  ...
  const createNewArticle = async () => {
    try {
      const res = await axios.post(
        `${baseUrl}/v2/api/${apiPath}/admin/article`,
        {
          data: {
            ...tempArticle,
  ...
  const btnUpdateArticle = async () => {
    try {
      const apiswitch =
        modalMode === 'create' ? createNewArticle : updateArticle;
      await apiswitch();
      getArticleList();
      closeModal();
    } catch (error) {
              ...
              <div className="col-12">
                <div className="border rounded-3 p-5 mb-3 ">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    />
                    <div>
                      <label htmlFor="fileInput" className="form-label ms-3">
                        {' '}
                      </label>
                      <button
                        type="button"
              ...
              <div className="col-12">
                <div className="border rounded-3 p-5 mb-3">
                  ...
                  <div className="row g-4">
                    <div className="col-6">
                      <label htmlFor="articleCode" className="form-label">
                        文章編號
                      </label>
                      <input
                        type="text"
