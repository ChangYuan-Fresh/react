...
function Footer () {
    return (
        <div className="bg-secondary pt-11 pb-0 pb-lg-9">
                    ...
                    <div className="row align-items-center align-items-lg-start">
                        ...
                        <div className="col-lg-3 text-center text-lg-start">
                            <div className="card mb-5">
                                ...
                                <ul className="list-group list-group-flush">
                                    <li
                                        className="list-group-item d-flex justify-content-center justify-content-lg-start pt-0 pb-4 pb-lg-7"
                                    >
                                    ...
                                    <li className="list-group-item pb-1 pb-lg-3 pt-0">
                                        <span
                                            className="material-symbols-outlined align-middle me-3 fs-4 fs-lg-2"
                                        >call</span
                                        >
                                        <Link className="fs-7 en-font fw-normal fs-lg-5" to='tel:+886-4-8656565'>
                                            (04)8656565
                                        </Link>
                                    </li>
                            ...
                            <div className="d-lg-none">
                                ...
                                <p className="fs-7 fw-normal">本站僅供學習使用，不提供商業用途</p>
                            </div>
                        </div>
                    </div>
                </div>
